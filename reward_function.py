...
def ai_detection_reward(completions: list[str]) -> list[float | None]:
    """
    ...
    # trim everything before </think> and trim any whitespace
    completions = [completion.split('</think>')[1].strip() for completion in completions]
    ...
    for i, completion in enumerate(completions):
        try:
            ...
            reward = ((1 - detection_score) * 2) ** 2 / 4
            ...
            rewards.append(None)  # Return neutral reward on error
